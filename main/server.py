...
from fastapi import Header, Form, Cookie, Response
...
app = create_app()
signup_controller = create_signup_controller()
...
def signup(username: str, password: str):
    return signup_controller.handle(
        username=username,
        password=password,
    )


@app.get("/ch01/list/users/pending")
